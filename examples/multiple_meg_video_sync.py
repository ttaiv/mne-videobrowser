"""Run video browser in sync with two MNE raw data browsers using MNE sample data.
...
def main() -> None:
    ...
    # Create mapping between two raw data browsers.
    # Here we just use the same raw data for both browsers.
    raw_aligner = TimestampAligner(
        timestamps_a=raw.times,
        timestamps_b=raw.times,
        timestamp_unit="seconds",
        name_a="raw1",
        name_b="raw2",
    )
